...
export default class Fov implements Renderable {
    ...
    update(state: GameState) {
        ...
        this.obsticlesFov = this.obsInLineOfSite(state.obsticles)
    }
    ...
    private obsInLineOfSite(walls: Obsticle[]): Obsticle[] {
        return walls.filter(w => {
            let closestPoint = w.closestPoint(this.element.pos)
